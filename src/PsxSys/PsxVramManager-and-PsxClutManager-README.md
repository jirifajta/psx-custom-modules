...
Use function vram_manager_insert_particular_area(...) to set these buffers.
...
2. Or, after inserting texture, use vram_manager_vram_align_delta(...) function to adjust the offset of texture coords. This function calculates the offset.
   And use vram_manager_move_vt_based_on_not_aligned_texture_update_vt_only(DVECTOR *vt_shift, DVECTOR *vts, u_long num_vt) to applay the offset to the primitives UV.
